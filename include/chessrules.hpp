...
private:    
    ...
    void AddValidPawnMoves(int x, int y, Direction direction, int max_squares,bool evalenPassant ,std::vector<Point>& moves, const Board & board);
    ...
    std::vector<Point> ComputePawnValidMoves(int x, int y, int max_n,bool isWhite,bool evalenPassant,const Board & board);
